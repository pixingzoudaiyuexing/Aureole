...
/*
  Content-Security-Policy: default-src 'self'; base-uri 'self'; object-src 'none'; frame-ancestors 'none'; form-action 'self'; connect-src 'self' https://client.crisp.chat https://client.relay.crisp.chat wss://client.relay.crisp.chat wss://client.relay.rescue.crisp.chat https://storage.crisp.chat; script-src 'self' https://client.crisp.chat ${hashes.join(' ')}; style-src 'self' 'unsafe-inline' https://client.crisp.chat; font-src 'self' data: https://client.crisp.chat; frame-src https:
`
